...
impl Margin {
  ...
  pub fn horizontal(value: u16) -> Self {
    Self { left: value, right: value, top: 0, bottom: 0 }
  }

  /// Set the margin of top and bottom sides to specified value.
  pub fn vertical(value: u16) -> Self {
    Self { left: 0, right: 0, top: value, bottom: value }
  }
...
impl Rect {
  ...
  pub fn clip_right(self, width: u16) -> Rect {
    Rect { width: self.width.saturating_sub(width), ..self }
  }
  ...
  pub fn clip_bottom(self, height: u16) -> Rect {
    Rect { height: self.height.saturating_sub(height), ..self }
  }
  ...
  fn from(style: UnderlineStyle) -> Self {
    match style {
      ...
      UnderlineStyle::DoubleLine => {
        crossterm::style::Attribute::DoubleUnderlined
      },
...
bitflags! {
    ...
    ///
    /// ```rust
    /// # use sazid_view::graphics::Modifier;
    ///
...
///
/// ```rust
/// # use sazid_view::graphics::{Color, Modifier, Style};
/// Style::default()
///     .fg(Color::Black)
///     .bg(Color::Green)
...
///
/// ```rust
/// # use sazid_view::graphics::{Rect, Color, UnderlineStyle, Modifier, Style};
...
impl Style {
  ...
  ///
  /// ```rust
  /// # use sazid_view::graphics::{Color, Style};
  ...
  ///
  /// ```rust
  /// # use sazid_view::graphics::{UnderlineStyle, Style};
